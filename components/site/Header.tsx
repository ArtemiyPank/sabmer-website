...
import { sectionProgress } from "@/components/elevator3d/tour";
...
export default function Header() {
  ...
  // Every in-page anchor rides to the camera stop that section belongs to,
  // so a link always parks the tour on the matching plate instead of dropping
  // it wherever the section happens to start.
  useEffect(() => {
    const onClick = (e: MouseEvent) => {
      ...
      e.preventDefault();
      rideToProgress(sectionProgress(id));
