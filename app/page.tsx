...
export default function Home() {
  return (
    <main>
      ...
      <DemoSection
        title="О компании"
        note="Разборка начинается с первых процентов прокрутки: двери, фотозавеса, порог."
      />
      <DemoSection
        title="Основатели"
        note="~30–50% — оператор, линейка кареток, COP, панели, потолок с вентилятором и пол."
      />
      <DemoSection
        title="Карьера"
        note="~50–70% — рама, ролики, ловители; кабина уже почти полностью — чертёж."
      />
      <DemoSection
        title="Контакты"
        note="~85% — разобранный чертёж собран: подписи, размерные линии, противовес наверху."
      />
    </main>
  );
}
